...
export default function Hero() {
    return (
        <section className="p-4 mx-auto max-w-screen-xl h-full w-full mb-[5rem]">
            <div className="grid grid-cols-1 md:grid-cols-2 items-center">
                <div>
                    ...
                    <button className="p-4 mt-5 bg-blue-500 px-4 rounded-full hover:scale-105 transition-all text-white" onClick={useScrollToBottom}>Explore Cars</button>
                </div>
                <div>
